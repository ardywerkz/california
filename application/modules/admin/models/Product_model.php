...
class Product_model extends CI_Model
{
    ...
    public function add_product($data)
    {
        ...
        $insert_data['selling'] = $data['selling'];
    ...
    {
        $this->db->select('product.*, category.name, admin.username, store_category.store_name');
        $this->db->from('product');
        $this->db->join('category', 'category.id = product.category_id', 'left');
        $this->db->join('admin', 'admin.id = product.user_id', 'left');
        $this->db->join('store_category', 'store_category.id = product.store_id', 'left');
